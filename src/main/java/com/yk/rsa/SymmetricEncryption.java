...
public class SymmetricEncryption
{
     ...
     * des加密
     */
    public static ByteBuffer desEncrypt(byte[] source) throws Exception
    {
        SecureRandom randomDESKey = new SecureRandom(new String(CommonConfig.getInstance().getSymmetrickey()).getBytes());
        byte[] passwd = new byte[8];
        randomDESKey.nextBytes(passwd);
        
        SecureRandom randomSalt = new SecureRandom(new String(CommonConfig.getInstance().getSymmetricsalt()).getBytes());
     ...
     * des解密
     */
    public static ByteBuffer desDecrypt(byte[] source) throws Exception
    {
        SecureRandom randomDESKey = new SecureRandom(new String(CommonConfig.getInstance().getSymmetrickey()).getBytes());
        byte[] passwd = new byte[8];
        randomDESKey.nextBytes(passwd);
     ...
     * 3des 加密
     */
    public static ByteBuffer des3Encrypt(byte[] source) throws Exception
    {
        SecureRandom randomDESKey = new SecureRandom(new String(CommonConfig.getInstance().getSymmetrickey()).getBytes());
     ...
     * 3des解密
     */
    public static ByteBuffer des3Decrypt(byte[] source) throws Exception
    {
        SecureRandom randomDESKey = new SecureRandom(new String(CommonConfig.getInstance().getSymmetrickey()).getBytes());
        byte[] passwd = new byte[24];
        randomDESKey.nextBytes(passwd);
     ...
     *       
     */
    public static ByteBuffer pbeEncrypt(byte[] source) throws Exception
    {
        SecureRandom randomSalt = new SecureRandom(new String(CommonConfig.getInstance().getSymmetricsalt()).getBytes());
        byte[] salt = new byte[24];
        randomSalt.nextBytes(salt);
        
        PBEKeySpec pbeKeySpec = new PBEKeySpec(CommonConfig.getInstance().getSymmetrickey());
     ...
     * PBE解密
     */
    public static ByteBuffer pbeDecrypt(byte[] source) throws Exception
    {
        SecureRandom randomSalt = new SecureRandom(new String(CommonConfig.getInstance().getSymmetricsalt()).getBytes());
        byte[] salt = new byte[24];
        randomSalt.nextBytes(salt);
     ...
     * aes256
     */
    public static ByteBuffer aesEncrypt(byte[] source) throws Exception
    {
        KeyGenerator keyGenerator = KeyGenerator.getInstance("AES");
        SecureRandom sr = new SecureRandom(new String(CommonConfig.getInstance().getSymmetrickey()).getBytes());
     ...
     *
     */
    public static ByteBuffer aesDecrypt(byte[] source) throws Exception
    {
        KeyGenerator keyGenerator = KeyGenerator.getInstance("AES");
        SecureRandom sr = new SecureRandom(new String(CommonConfig.getInstance().getSymmetrickey()).getBytes());
     ...
     * aes256
     */
    public static ByteBuffer aesEncrypt2(byte[] source) throws Exception
    {
        SecureRandom randomDESKey = new SecureRandom(new String(CommonConfig.getInstance().getSymmetrickey()).getBytes());
     ...
     *
     */
    public static ByteBuffer aesDecrypt2(byte[] source) throws Exception
    {
        SecureRandom randomDESKey = new SecureRandom(new String(CommonConfig.getInstance().getSymmetrickey()).getBytes());
        byte[] passwd = new byte[32];
        randomDESKey.nextBytes(passwd);
